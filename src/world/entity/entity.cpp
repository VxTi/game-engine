...
Entity::Entity(glm::vec3 position, glm::vec3 velocity, glm::vec3 acceleration,
...
Entity::Entity()
    : Entity(glm::vec3(0.0f), glm::vec3(0.0f), glm::vec3(0.0f), glm::vec3(0.0f),
             1.0f, 1.0f) {}

void Entity::update(float deltaTime) {
  // s = ut + 0.5at^2
  this->position = this->position + this->velocity * deltaTime +
                   0.5f * this->acceleration * deltaTime * deltaTime;
  // v = u + at
