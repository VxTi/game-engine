...
public:
   ...
   * This constructor will generate the frustum based on the provided
   * parameters, which can then be used to check whether objects are visible
   * from the source.
   * @param observer The source of the frustum
   * @param viewMatrix The view matrix of the frustum
   * @param projectionMatrix The projection matrix of the frustum
   */
  Frustum(glm::mat4 viewMatrix, glm::mat4 projectionMatrix);
   ...
   * @param projectionMatrix The projection matrix of the frustum
   */
  void updateViewProjectionMatrix(glm::mat4 viewMatrix,
   ...
   */
  bool isWithin(Transform &observer, glm::vec3 referencePosition);
   ...
   * @return Whether the object is within the frustum
   */
  bool isWithin(Transform &observer, glm::vec3 referencePosition, float radius);
